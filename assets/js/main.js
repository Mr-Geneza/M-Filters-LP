...
(function($){
    ...
    $("a.gallery2").fancybox(
        {
            "padding" : 20, // Ð¾Ñ‚ÑÑ‚ÑƒÐ¿ ÐºÐ¾Ð½Ñ‚ÐµÐ½Ñ‚Ð° Ð¾Ñ‚ ÐºÑ€Ð°ÐµÐ² Ð¾ÐºÐ½Ð°
            "imageScale" : false, // ÐŸÑ€Ð¸Ð½Ð¸Ð¼Ð°ÐµÑ‚ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ðµ true - ÐºÐ¾Ð½Ñ‚ÐµÐ½Ñ‚(Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ) Ð¼Ð°ÑÑˆÑ‚Ð°Ð±Ð¸Ñ€ÑƒÐµÑ‚ÑÑ Ð¿Ð¾ Ñ€Ð°Ð·Ð¼ÐµÑ€Ñƒ Ð¾ÐºÐ½Ð°, Ð¸Ð»Ð¸ false - Ð¾ÐºÐ½Ð¾ Ð²Ñ‹Ñ‚ÑÐ³Ð¸Ð²Ð°ÐµÑ‚ÑÑ Ð¿Ð¾ Ñ€Ð°Ð·Ð¼ÐµÑ€Ñƒ ÐºÐ¾Ð½Ñ‚ÐµÐ½Ñ‚Ð°. ÐŸÐ¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ - TRUE
            "zoomOpacity" : false,	// Ð¸Ð·Ð¼ÐµÐ½ÐµÐ½Ð¸Ðµ Ð¿Ñ€Ð¾Ð·Ñ€Ð°Ñ‡Ð½Ð¾ÑÑ‚Ð¸ ÐºÐ¾Ð½Ñ‚ÐµÐ½Ñ‚Ð° Ð²Ð¾ Ð²Ñ€ÐµÐ¼Ñ Ð°Ð½Ð¸Ð¼Ð°Ñ†Ð¸Ð¸ (Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ false)
            "zoomSpeedIn" : 1000,	// ÑÐºÐ¾Ñ€Ð¾ÑÑ‚ÑŒ Ð°Ð½Ð¸Ð¼Ð°Ñ†Ð¸Ð¸ Ð² Ð¼Ñ Ð¿Ñ€Ð¸ ÑƒÐ²ÐµÐ»Ð¸Ñ‡ÐµÐ½Ð¸Ð¸ Ñ„Ð¾Ñ‚Ð¾ (Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ 0)
            "zoomSpeedOut" : 1000,	// ÑÐºÐ¾Ñ€Ð¾ÑÑ‚ÑŒ Ð°Ð½Ð¸Ð¼Ð°Ñ†Ð¸Ð¸ Ð² Ð¼Ñ Ð¿Ñ€Ð¸ ÑƒÐ¼ÐµÐ½ÑŒÑˆÐµÐ½Ð¸Ð¸ Ñ„Ð¾Ñ‚Ð¾ (Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ 0)
            "zoomSpeedChange" : 1000, // ÑÐºÐ¾Ñ€Ð¾ÑÑ‚ÑŒ Ð°Ð½Ð¸Ð¼Ð°Ñ†Ð¸Ð¸ Ð² Ð¼Ñ Ð¿Ñ€Ð¸ ÑÐ¼ÐµÐ½Ðµ Ñ„Ð¾Ñ‚Ð¾ (Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ 0)
            "frameWidth" : 700,	 // ÑˆÐ¸Ñ€Ð¸Ð½Ð° Ð¾ÐºÐ½Ð°, px (425px - Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ)
            "frameHeight" : 600, // Ð²Ñ‹ÑÐ¾Ñ‚Ð° Ð¾ÐºÐ½Ð°, px(355px - Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ)
            "overlayShow" : true, // ÐµÑÐ»Ð¸ true Ð·Ð°Ñ‚ÐµÐ½ÑÑÑ‚ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñƒ Ð¿Ð¾Ð´ Ð²ÑÐ¿Ð»Ñ‹Ð²Ð°ÑŽÑ‰Ð¸Ð¼ Ð¾ÐºÐ½Ð¾Ð¼. (Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ true). Ð¦Ð²ÐµÑ‚ Ð·Ð°Ð´Ð°ÐµÑ‚ÑÑ Ð² jquery.fancybox.css - div#fancy_overlay
            "overlayOpacity" : 0.8,	 // ÐŸÑ€Ð¾Ð·Ñ€Ð°Ñ‡Ð½Ð¾ÑÑ‚ÑŒ Ð·Ð°Ñ‚ÐµÐ½ÐµÐ½Ð¸Ñ 	(0.3 Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ)
            "hideOnContentClick" :false, // Ð•ÑÐ»Ð¸ TRUE  Ð·Ð°ÐºÑ€Ñ‹Ð²Ð°ÐµÑ‚ Ð¾ÐºÐ½Ð¾ Ð¿Ð¾ ÐºÐ»Ð¸ÐºÑƒ Ð¿Ð¾ Ð»ÑŽÐ±Ð¾Ð¹ ÐµÐ³Ð¾ Ñ‚Ð¾Ñ‡ÐºÐµ (ÐºÑ€Ð¾Ð¼Ðµ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ð¾Ð² Ð½Ð°Ð²Ð¸Ð³Ð°Ñ†Ð¸Ð¸). ÐŸÐ¾ÑƒÐ¼Ð¾Ð»Ñ‡Ð°Ð½Ð¸ÑŽ TRUE
            "centerOnScroll" : false // Ð•ÑÐ»Ð¸ TRUE Ð¾ÐºÐ½Ð¾ Ñ†ÐµÐ½Ñ‚Ñ€Ð¸Ñ€ÑƒÐµÑ‚ÑÑ Ð½Ð° ÑÐºÑ€Ð°Ð½Ðµ, ÐºÐ¾Ð³Ð´Ð° Ð¿Ð¾Ð»ÑŒÐ·Ð¾Ð²Ð°Ñ‚ÐµÐ»ÑŒ Ð¿Ñ€Ð¾ÐºÑ€ÑƒÑ‡Ð¸Ð²Ð°ÐµÑ‚ ÑÑ‚Ñ€Ð°Ð½Ð¸Ñ†Ñƒ
